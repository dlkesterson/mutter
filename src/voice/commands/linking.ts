...
const linkingCommands: VoiceCommand[] = [
  ...
  // ====================================
  {
    ...
    scope: 'document',
    reversible: false,
    action: () => dispatchEditorCommand('suggestLinks'),
  },
  {
    id: 'ai-suggest-links-selection',
    name: 'Suggest links for selection',
    examples: [
      'suggest links for this',
      'what should this link to',
      'link suggestions for selection',
    ...
    scope: 'inline',
    reversible: false,
    action: () => dispatchEditorCommand('suggestLinksForSelection'),
  },
  {
    id: 'ai-auto-link-paragraph',
    name: 'Auto-link paragraph',
    examples: [
      'auto link this paragraph',
    ...
    scope: 'block',
    reversible: true,
    action: () => dispatchEditorCommand('autoLinkParagraph'),
  },
  {
    id: 'ai-find-unlinked-mentions',
    name: 'Find unlinked mentions',
    examples: [
      'find unlinked mentions',
      'unlinked mentions',
      'what mentions this note',
    ...
    scope: 'vault',
    reversible: false,
    action: () => dispatchEditorCommand('findUnlinkedMentions'),
  },
  {
    id: 'ai-link-unlinked-mentions',
    name: 'Link all unlinked mentions',
    examples: [
    ...
    scope: 'vault',
    reversible: true,
    action: () => dispatchEditorCommand('linkUnlinkedMentions'),
  },
  {
    id: 'ai-similar-notes',
    ...
    scope: 'vault',
    reversible: false,
    action: () => dispatchEditorCommand('showSimilarNotes'),
  },
];
