...
function buildHeadingTree(headings: HeadingInfo[]): HeadingNode[] {
    ...
    const stack: { level: number; children: HeadingNode[] }[] = [{ level: 0, children: root }];
...
function HeadingItem({ node, depth, onNavigate, collapsedState, onToggleCollapse }: HeadingItemProps) {
...
export function OutlinePanel({ content, onNavigate, className }: OutlinePanelProps) {
