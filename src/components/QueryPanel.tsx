      ...
      {!result && !query && (
        <div className="flex-1 flex flex-col items-center justify-center space-y-4">
          ...
          <div className="text-xs text-muted-foreground space-y-1">
            <p>
              <code className="px-1 py-0.5 bg-muted rounded">type:project</code>{' '}
              — Notes with a supertag
            </p>
            <p>
              <code className="px-1 py-0.5 bg-muted rounded">tag:work</code> — Notes
              with a markdown tag
            </p>
            <p>
              <code className="px-1 py-0.5 bg-muted rounded">linked:[[Note]]</code>{' '}
              — Notes linking to Note
            </p>
            <p>
              <code className="px-1 py-0.5 bg-muted rounded">has:supertags</code>{' '}
